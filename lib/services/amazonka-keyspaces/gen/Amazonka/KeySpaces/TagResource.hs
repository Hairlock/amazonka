...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) of the Amazon Keyspaces resource to which
-- to add tags.
--
-- 'tags', 'tagResource_tags' - The tags to be assigned to the Amazon Keyspaces resource.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tags'
...
instance Data.ToHeaders TagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "KeyspacesService.TagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
