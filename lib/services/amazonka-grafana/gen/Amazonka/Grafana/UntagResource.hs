...
-- |
-- Module      : Amazonka.Grafana.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The ARN of the resource the tag association is removed from.
--
-- 'tagKeys', 'untagResource_tagKeys' - The key values of the tag to be removed from the resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
