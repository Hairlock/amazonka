...
-- |
-- Module      : Amazonka.Grafana.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The ARN of the resource the list of tags are associated with.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The list of tags that are associated with the resource.
--
