...
-- |
-- Module      : Amazonka.DeviceFarm.UntagResource
...
--
-- 'resourceARN', 'untagResource_resourceARN' - The Amazon Resource Name (ARN) of the resource or resources from which
-- to delete tags. You can associate tags with the following Device Farm
-- resources: @PROJECT@, @RUN@, @NETWORK_PROFILE@, @INSTANCE_PROFILE@,
-- @DEVICE_INSTANCE@, @SESSION@, @DEVICE_POOL@, @DEVICE@, and
-- @VPCE_CONFIGURATION@.
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "DeviceFarm_20150623.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
