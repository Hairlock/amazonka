...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource whose tags you want to
-- retrieve.
--
-- -   Format example:
--     @arn:aws:geo:region:account-id:resourcetype\/ExampleResource@
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - Tags that have been applied to the specified resource. Tags are mapped
-- from the tag key to the tag value: @\"TagKey\" : \"TagValue\"@.
--
-- -   Format example: @{\"tag1\" : \"value1\", \"tag2\" : \"value2\"} @
--
