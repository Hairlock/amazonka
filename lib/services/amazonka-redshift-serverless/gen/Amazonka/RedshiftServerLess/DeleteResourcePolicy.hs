...
-- |
-- Module      : Amazonka.RedshiftServerLess.DeleteResourcePolicy
...
--
-- 'resourceArn', 'deleteResourcePolicy_resourceArn' - The Amazon Resource Name (ARN) of the policy to delete.
newDeleteResourcePolicy ::
  -- | 'resourceArn'
  Prelude.Text ->
  DeleteResourcePolicy
...
instance Data.ToHeaders DeleteResourcePolicy where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "RedshiftServerless.DeleteResourcePolicy" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
