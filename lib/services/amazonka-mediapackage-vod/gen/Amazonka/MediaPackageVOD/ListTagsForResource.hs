...
-- |
-- Module      : Amazonka.MediaPackageVOD.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) for the resource. You can get this from
-- the response to any request to the resource.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A collection of tags associated with a resource
--
