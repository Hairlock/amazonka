...
userAuthConfig_clientPasswordAuthType = Lens.lens (\UserAuthConfig' {clientPasswordAuthType} -> clientPasswordAuthType) (\s@UserAuthConfig' {} a -> s {clientPasswordAuthType = a} :: UserAuthConfig)
