...
-- |
-- Module      : Amazonka.ApiGatewayV2.TagResource
...
--
-- 'tags', 'tagResource_tags' - The collection of tags. Each tag element is associated with a given
-- resource.
--
-- 'resourceArn', 'tagResource_resourceArn' - The resource ARN for the tag.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  TagResource
