...
-- |
-- Module      : Amazonka.SageMakerGeoSpatial.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the resource you want to untag.
--
-- 'tagKeys', 'untagResource_tagKeys' - Keys of the tags you want to remove.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
