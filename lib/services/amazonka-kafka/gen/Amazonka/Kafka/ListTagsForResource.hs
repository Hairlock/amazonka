...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) that uniquely identifies the resource
-- that\'s associated with the tags.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The key-value pair for the resource tag.
--
