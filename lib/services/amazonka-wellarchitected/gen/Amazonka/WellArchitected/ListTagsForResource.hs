...
--
-- 'workloadArn', 'listTagsForResource_workloadArn' - Undocumented member.
newListTagsForResource ::
  -- | 'workloadArn'
  Prelude.Text ->
  ListTagsForResource
newListTagsForResource pWorkloadArn_ =
  ListTagsForResource' {workloadArn = pWorkloadArn_}

-- | Undocumented member.
listTagsForResource_workloadArn :: Lens.Lens' ListTagsForResource Prelude.Text
listTagsForResource_workloadArn = Lens.lens (\ListTagsForResource' {workloadArn} -> workloadArn) (\s@ListTagsForResource' {} a -> s {workloadArn = a} :: ListTagsForResource)
