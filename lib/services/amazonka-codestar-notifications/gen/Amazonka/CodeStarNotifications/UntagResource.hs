...
--
-- 'arn', 'untagResource_arn' - The Amazon Resource Name (ARN) of the notification rule from which to
-- remove the tags.
--
-- 'tagKeys', 'untagResource_tagKeys' - The key names of the tags to remove.
newUntagResource ::
  -- | 'arn'
  Prelude.Text ->
  UntagResource
