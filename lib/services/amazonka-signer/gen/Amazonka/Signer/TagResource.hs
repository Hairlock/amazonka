...
-- |
-- Module      : Amazonka.Signer.TagResource
...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) for the signing profile.
--
-- 'tags', 'tagResource_tags' - One or more tags to be associated with the signing profile.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  TagResource
