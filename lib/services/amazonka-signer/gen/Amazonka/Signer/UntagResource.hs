...
-- |
-- Module      : Amazonka.Signer.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) for the signing profile.
--
-- 'tagKeys', 'untagResource_tagKeys' - A list of tag keys to be removed from the signing profile.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
