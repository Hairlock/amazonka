...
-- |
-- Module      : Amazonka.ConnectCases.ListTagsForResource
...
--
-- 'arn', 'listTagsForResource_arn' - The Amazon Resource Name (ARN)
newListTagsForResource ::
  -- | 'arn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A map of of key-value pairs that represent tags on a resource. Tags are
-- used to organize, track, or control access for this resource.
--
