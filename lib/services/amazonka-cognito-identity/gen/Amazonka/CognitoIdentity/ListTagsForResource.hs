...
-- |
-- Module      : Amazonka.CognitoIdentity.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the identity pool that the tags are
-- assigned to.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AWSCognitoIdentityService.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tags that are assigned to the identity pool.
--
