...
-- |
-- Module      : Amazonka.PinpointSmsVoiceV2.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource to query for.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "PinpointSMSVoiceV2.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'resourceArn', 'listTagsForResourceResponse_resourceArn' - The ARN of the resource.
--
-- 'tags', 'listTagsForResourceResponse_tags' - An array of key and value pair tags that are associated with the
-- resource.
--
