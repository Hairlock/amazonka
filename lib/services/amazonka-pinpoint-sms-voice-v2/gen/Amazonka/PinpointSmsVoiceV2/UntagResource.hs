...
-- |
-- Module      : Amazonka.PinpointSmsVoiceV2.UntagResource
...
-- SMS Voice V2 resource. For more information on tags see
-- <https://docs.aws.amazon.com/pinpoint/latest/developerguide/tagging-resources.html Tagging Amazon Pinpoint resources>
...
--
-- 'tagKeys', 'untagResource_tagKeys' - An array of tag key values to unassociate with the resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "PinpointSMSVoiceV2.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
