...
-- |
-- Module      : Amazonka.PinpointSmsVoiceV2.TagResource
...
--
-- 'tags', 'tagResource_tags' - An array of key and value pair tags that are associated with the
-- resource.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders TagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "PinpointSMSVoiceV2.TagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
