...
-- |
-- Module      : Amazonka.DocDbElastic.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The arn of the Elastic DocumentDB resource.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The list of tags for the specified Elastic DocumentDB resource.
--
