...
-- |
-- Module      : Amazonka.DocDbElastic.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The arn of the Elastic DocumentDB resource.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag keys to be removed from the Elastic DocumentDB resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
