...
-- |
-- Module      : Amazonka.MarketplaceCatalog.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - Required. The Amazon Resource Name (ARN) associated with the resource
-- you want to remove the tag from.
--
-- 'tagKeys', 'untagResource_tagKeys' - Required. A list of key names of tags to be removed. Number of strings
-- allowed: 0-256.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
