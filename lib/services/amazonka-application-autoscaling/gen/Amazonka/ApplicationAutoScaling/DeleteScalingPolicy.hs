...
-- |
-- Module      : Amazonka.ApplicationAutoScaling.DeleteScalingPolicy
...
-- <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html#delete-step-scaling-policy Delete a step scaling policy>
-- and
-- <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html#delete-target-tracking-policy Delete a target tracking scaling policy>
