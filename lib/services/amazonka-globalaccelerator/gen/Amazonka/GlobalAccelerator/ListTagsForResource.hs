...
-- |
-- Module      : Amazonka.GlobalAccelerator.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the accelerator to list tags for. An
-- ARN uniquely identifies an accelerator.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "GlobalAccelerator_V20180706.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - Root level tag for the Tags parameters.
--
