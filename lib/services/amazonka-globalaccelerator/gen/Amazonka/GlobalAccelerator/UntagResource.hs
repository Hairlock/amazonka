...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the Global Accelerator resource to
-- remove tags from. An ARN uniquely identifies a resource.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag key pairs that you want to remove from the specified resources.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "GlobalAccelerator_V20180706.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
