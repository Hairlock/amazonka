...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) of the Global Accelerator resource to add
-- tags to. An ARN uniquely identifies a resource.
--
-- 'tags', 'tagResource_tags' - The tags to add to a resource. A tag consists of a key and a value that
-- you define.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders TagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "GlobalAccelerator_V20180706.TagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
