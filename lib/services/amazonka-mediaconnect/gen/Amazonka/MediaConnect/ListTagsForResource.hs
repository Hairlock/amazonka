...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) that identifies the AWS Elemental
-- MediaConnect resource for which to list the tags.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A map from tag keys to values. Tag keys can have a maximum character
-- length of 128 characters, and tag values can have a maximum length of
-- 256 characters.
--
