...
-- |
-- Module      : Amazonka.BillingConductor.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the resource to which to delete tags.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tags to delete from the resource as a list of key-value pairs.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
