...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the Amazon MWAA environment. For
-- example,
-- @arn:aws:airflow:us-east-1:123456789012:environment\/MyMWAAEnvironment@.
--
-- 'tagKeys', 'untagResource_tagKeys' - The key-value tag pair you want to remove. For example,
-- @\"Environment\": \"Staging\"@.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
