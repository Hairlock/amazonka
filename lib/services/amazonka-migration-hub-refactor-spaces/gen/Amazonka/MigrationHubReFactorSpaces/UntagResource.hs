...
-- |
-- Module      : Amazonka.MigrationHubReFactorSpaces.UntagResource
...
-- account must be the same as the resource’s @OwnerAccountId@. Untagging
...
--
-- 'tagKeys', 'untagResource_tagKeys' - The list of keys of the tags to be removed from the resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
