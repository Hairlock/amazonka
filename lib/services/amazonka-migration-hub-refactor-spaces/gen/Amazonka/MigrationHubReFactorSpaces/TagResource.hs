...
-- |
-- Module      : Amazonka.MigrationHubReFactorSpaces.TagResource
...
-- used to manage a resource. To tag a resource, the caller account must be
-- the same as the resource’s @OwnerAccountId@. Tagging resources in other
