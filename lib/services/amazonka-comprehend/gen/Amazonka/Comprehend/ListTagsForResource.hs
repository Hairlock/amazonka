...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the given Amazon Comprehend resource
-- you are querying.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "Comprehend_20171127.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
