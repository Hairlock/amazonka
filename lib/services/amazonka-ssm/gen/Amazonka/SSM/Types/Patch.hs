...
instance Prelude.NFData Patch where
  rnf Patch' {..} =
    Prelude.rnf advisoryIds `Prelude.seq`
      Prelude.rnf arch `Prelude.seq`
        Prelude.rnf bugzillaIds `Prelude.seq`
                ...
                Prelude.rnf description `Prelude.seq`
                  Prelude.rnf epoch `Prelude.seq`
                    Prelude.rnf id `Prelude.seq`
                      Prelude.rnf kbNumber `Prelude.seq`
                        Prelude.rnf language `Prelude.seq`
                          Prelude.rnf msrcNumber `Prelude.seq`
                            Prelude.rnf msrcSeverity `Prelude.seq`
                              Prelude.rnf name `Prelude.seq`
                                Prelude.rnf product `Prelude.seq`
                                  Prelude.rnf productFamily `Prelude.seq`
