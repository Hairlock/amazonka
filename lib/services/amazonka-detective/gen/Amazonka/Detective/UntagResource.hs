...
-- |
-- Module      : Amazonka.Detective.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The ARN of the behavior graph to remove the tags from.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag keys of the tags to remove from the behavior graph. You can
-- remove up to 50 tags at a time.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
