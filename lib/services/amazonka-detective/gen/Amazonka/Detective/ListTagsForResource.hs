...
-- |
-- Module      : Amazonka.Detective.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The ARN of the behavior graph for which to retrieve the tag values.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tag values that are assigned to the behavior graph. The request
-- returns up to 50 tag values.
--
