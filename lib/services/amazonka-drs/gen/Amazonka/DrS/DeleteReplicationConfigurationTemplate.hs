...
-- |
-- Module      : Amazonka.DrS.DeleteReplicationConfigurationTemplate
...
--
-- 'replicationConfigurationTemplateID', 'deleteReplicationConfigurationTemplate_replicationConfigurationTemplateID' - The ID of the Replication Configuration Template to be deleted.
newDeleteReplicationConfigurationTemplate ::
