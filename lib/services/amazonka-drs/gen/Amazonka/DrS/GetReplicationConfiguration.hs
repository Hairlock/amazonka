...
-- |
-- Module      : Amazonka.DrS.GetReplicationConfiguration
...
--
-- 'sourceServerID', 'getReplicationConfiguration_sourceServerID' - The ID of the Source Serve for this Replication Configuration.r
newGetReplicationConfiguration ::
  -- | 'sourceServerID'
  Prelude.Text ->
  GetReplicationConfiguration
