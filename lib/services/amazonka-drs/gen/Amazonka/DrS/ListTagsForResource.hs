...
-- |
-- Module      : Amazonka.DrS.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The ARN of the resource whose tags should be returned.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tags of the requested resource.
--
