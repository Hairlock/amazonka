...
-- |
-- Module      : Amazonka.EMRServerless.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) that identifies the resource to list the
-- tags for. Currently, the supported resources are Amazon EMR Serverless
-- applications and job runs.
--
