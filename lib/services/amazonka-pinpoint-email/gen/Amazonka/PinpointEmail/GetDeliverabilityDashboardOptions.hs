...
-- of a Deliverability dashboard subscription, see
...
--
-- 'dashboardEnabled', 'getDeliverabilityDashboardOptionsResponse_dashboardEnabled' - Specifies whether the Deliverability dashboard is enabled for your
-- Amazon Pinpoint account. If this value is @true@, the dashboard is
-- enabled.
newGetDeliverabilityDashboardOptionsResponse ::
  -- | 'httpStatus'
