  ...
  rnf TaskSet' {..} =
    Prelude.rnf capacityProviderStrategy `Prelude.seq`
      Prelude.rnf clusterArn `Prelude.seq`
        Prelude.rnf computedDesiredCount `Prelude.seq`
                              ...
                              Prelude.rnf scale `Prelude.seq`
                                Prelude.rnf serviceArn `Prelude.seq`
                                  Prelude.rnf serviceRegistries `Prelude.seq`
                                    Prelude.rnf stabilityStatus `Prelude.seq`
                                      Prelude.rnf stabilityStatusAt `Prelude.seq`
                                        Prelude.rnf startedBy `Prelude.seq`
                                          Prelude.rnf status `Prelude.seq`
                                            Prelude.rnf tags `Prelude.seq`
                                              Prelude.rnf taskDefinition `Prelude.seq`
                                                Prelude.rnf taskSetArn `Prelude.seq`
