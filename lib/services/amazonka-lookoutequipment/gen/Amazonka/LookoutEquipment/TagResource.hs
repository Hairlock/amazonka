...
-- |
-- Module      : Amazonka.LookoutEquipment.TagResource
...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) of the specific resource to which the tag
-- should be associated.
--
-- 'tags', 'tagResource_tags' - The tag or tags to be associated with a specific resource. Both the tag
-- key and value are specified.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders TagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AWSLookoutEquipmentFrontendService.TagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
