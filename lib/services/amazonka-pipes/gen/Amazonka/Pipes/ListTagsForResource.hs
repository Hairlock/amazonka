...
-- |
-- Module      : Amazonka.Pipes.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The ARN of the pipe for which you want to view tags.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The list of key-value pairs to associate with the pipe.
--
