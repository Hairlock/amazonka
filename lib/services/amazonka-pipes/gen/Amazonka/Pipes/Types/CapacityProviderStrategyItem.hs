...
-- |
-- Module      : Amazonka.Pipes.Types.CapacityProviderStrategyItem
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.Pipes.Types.CapacityProviderStrategyItem where
...
data CapacityProviderStrategyItem = CapacityProviderStrategyItem'
  { -- | The base value designates how many tasks, at a minimum, to run on the
    ...
    capacityProvider :: Data.Sensitive Prelude.Text
  }
...
newCapacityProviderStrategyItem pCapacityProvider_ =
  CapacityProviderStrategyItem'
    { base =
      ...
      capacityProvider =
        Data._Sensitive Lens.# pCapacityProvider_
    }
...
capacityProviderStrategyItem_capacityProvider = Lens.lens (\CapacityProviderStrategyItem' {capacityProvider} -> capacityProvider) (\s@CapacityProviderStrategyItem' {} a -> s {capacityProvider = a} :: CapacityProviderStrategyItem) Prelude.. Data._Sensitive
