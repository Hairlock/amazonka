...
-- |
-- Module      : Amazonka.Pipes.Types.DeadLetterConfig
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.Pipes.Types.DeadLetterConfig where
...
--
-- 'arn', 'deadLetterConfig_arn' - The ARN of the Amazon SQS queue specified as the target for the
-- dead-letter queue.
newDeadLetterConfig ::
  DeadLetterConfig
newDeadLetterConfig =
