...
-- |
-- Module      : Amazonka.Pipes.Types.BatchArrayProperties
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.Pipes.Types.BatchArrayProperties where
...
--
-- 'size', 'batchArrayProperties_size' - The size of the array, if this is an array batch job.
...
-- | The size of the array, if this is an array batch job.
batchArrayProperties_size :: Lens.Lens' BatchArrayProperties (Prelude.Maybe Prelude.Natural)
