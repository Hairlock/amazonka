...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the Voice ID resource you want to
-- remove tags from.
--
-- 'tagKeys', 'untagResource_tagKeys' - The list of tag keys you want to remove from the specified resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
