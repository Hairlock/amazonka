...
-- |
-- Module      : Amazonka.CodeGuruProfiler.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the resource that contains the tags to
-- remove.
--
-- 'tagKeys', 'untagResource_tagKeys' - A list of tag keys. Existing tags of resources with keys in this list
-- are removed from the specified resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
