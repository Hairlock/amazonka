...
-- |
-- Module      : Amazonka.CodeGuruProfiler.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource that contains the tags to
-- return.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The list of tags assigned to the specified resource. This is the list of
-- tags returned in the response.
--
