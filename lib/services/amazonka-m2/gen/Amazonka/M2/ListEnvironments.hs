...
--
-- 'engineType', 'listEnvironments_engineType' - The engine type for the runtime environment.
--
-- 'maxResults', 'listEnvironments_maxResults' - The maximum number of runtime environments to return.
--
-- 'names', 'listEnvironments_names' - The names of the runtime environments. Must be unique within the
-- account.
--
-- 'nextToken', 'listEnvironments_nextToken' - A pagination token to control the number of runtime environments
-- displayed in the list.
newListEnvironments ::
  ListEnvironments
newListEnvironments =
...
--
-- 'environments', 'listEnvironmentsResponse_environments' - Returns a list of summary details for all the runtime environments in
-- your account.
newListEnvironmentsResponse ::
  -- | 'httpStatus'
  Prelude.Int ->
