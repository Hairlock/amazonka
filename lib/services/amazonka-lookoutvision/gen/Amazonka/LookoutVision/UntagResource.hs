...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the model from which you want to
-- remove tags.
--
-- 'tagKeys', 'untagResource_tagKeys' - A list of the keys of the tags that you want to remove.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
