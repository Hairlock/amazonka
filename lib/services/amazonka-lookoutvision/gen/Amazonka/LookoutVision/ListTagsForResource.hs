...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the model for which you want to list
-- tags.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToPath ListTagsForResource where
  toPath ListTagsForResource' {..} =
    Prelude.mconcat
      ["/2020-11-20/tags/", Data.toBS resourceArn]
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A map of tag keys and values attached to the specified model.
--
