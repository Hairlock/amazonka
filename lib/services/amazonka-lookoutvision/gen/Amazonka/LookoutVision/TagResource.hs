...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) of the model to assign the tags.
--
-- 'tags', 'tagResource_tags' - The key-value tags to assign to the model.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  TagResource
