...
-- |
-- Module      : Amazonka.Scheduler.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The ARN of the EventBridge Scheduler resource for which you want to view
-- tags.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
