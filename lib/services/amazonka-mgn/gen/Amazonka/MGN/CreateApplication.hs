...
-- |
-- Module      : Amazonka.MGN.CreateApplication
...
--
-- 'description', 'createApplication_description' - Application description.
--
-- 'tags', 'createApplication_tags' - Application tags.
--
-- 'name', 'createApplication_name' - Application name.
newCreateApplication ::
  -- | 'name'
  Prelude.Text ->
  CreateApplication
...
instance Data.ToPath CreateApplication where
  toPath = Prelude.const "/CreateApplication"
