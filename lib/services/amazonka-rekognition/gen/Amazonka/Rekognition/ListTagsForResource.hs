...
-- |
-- Module      : Amazonka.Rekognition.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - Amazon Resource Name (ARN) of the model, collection, or stream processor
-- that contains the tags that you want a list of.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "RekognitionService.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A list of key-value tags assigned to the resource.
--
