...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) string that uniquely identifies the
-- DataBrew resource.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A list of tags associated with the DataBrew resource.
--
