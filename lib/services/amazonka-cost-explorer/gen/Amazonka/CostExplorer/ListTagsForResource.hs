...
-- |
-- Module      : Amazonka.CostExplorer.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource. For a list of supported
-- resources, see
-- <https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_ResourceTag.html ResourceTag>.
newListTagsForResource ::
  -- | 'resourceArn'
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AWSInsightsIndexService.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'resourceTags', 'listTagsForResourceResponse_resourceTags' - A list of tag key value pairs that are associated with the resource.
--
...
-- | A list of tag key value pairs that are associated with the resource.
listTagsForResourceResponse_resourceTags :: Lens.Lens' ListTagsForResourceResponse (Prelude.Maybe [ResourceTag])
