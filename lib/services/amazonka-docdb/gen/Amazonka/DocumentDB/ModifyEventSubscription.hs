...
-- |
-- Module      : Amazonka.DocumentDB.ModifyEventSubscription
...
--
-- 'enabled', 'modifyEventSubscription_enabled' - A Boolean value; set to @true@ to activate the subscription.
--
...
-- Valid values: @db-instance@, @db-parameter-group@, @db-security-group@
--
-- 'subscriptionName', 'modifyEventSubscription_subscriptionName' - The name of the Amazon DocumentDB event notification subscription.
newModifyEventSubscription ::
  -- | 'subscriptionName'
  Prelude.Text ->
  ModifyEventSubscription
