...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) that specifies from which resource to
-- disassociate the tags with the keys in the @TagKeys@ input parameter.
--
-- 'tagKeys', 'untagResource_tagKeys' - A list of keys of @Tag@ objects. The @Tag@ objects identified by the
-- keys are disassociated from the resource specified by the @ResourceArn@
-- input parameter.
newUntagResource ::
  -- | 'resourceArn'
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "CodeDeploy_20141006.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
