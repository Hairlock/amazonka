...
-- |
-- Module      : Amazonka.ChimeSdkMediaPipelines.ListTagsForResource
...
--
-- 'resourceARN', 'listTagsForResource_resourceARN' - The ARN of the media pipeline associated with any tags. The ARN consists
-- of the pipeline\'s region, resource ID, and pipeline ID.
newListTagsForResource ::
  -- | 'resourceARN'
  Prelude.Text ->
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tags associated with the specified media pipeline.
--
