...
-- |
-- Module      : Amazonka.ServiceQuotas.ListTagsForResource
...
--
-- 'resourceARN', 'listTagsForResource_resourceARN' - The Amazon Resource Name (ARN) for the applied quota for which you want
-- to list tags. You can get this information by using the Service Quotas
-- console, or by listing the quotas using the
-- <https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-service-quotas.html list-service-quotas>
-- AWS CLI command or the
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "ServiceQuotasV20190624.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A complex data type that contains zero or more tag elements.
--
