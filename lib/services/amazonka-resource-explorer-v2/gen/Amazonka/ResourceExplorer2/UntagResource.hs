...
-- |
-- Module      : Amazonka.ResourceExplorer2.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the view or index that you want to
-- remove tags from.
--
-- 'tagKeys', 'untagResource_tagKeys' - A list of the keys for the tags that you want to remove from the
-- specified view or index.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
