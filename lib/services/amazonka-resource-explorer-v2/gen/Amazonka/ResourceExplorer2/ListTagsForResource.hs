...
-- |
-- Module      : Amazonka.ResourceExplorer2.ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tag key and value pairs that you want to attach to the specified
-- view or index.
--
