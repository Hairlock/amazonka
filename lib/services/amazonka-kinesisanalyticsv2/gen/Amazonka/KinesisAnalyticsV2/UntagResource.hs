...
-- |
-- Module      : Amazonka.KinesisAnalyticsV2.UntagResource
...
--
-- 'resourceARN', 'untagResource_resourceARN' - The ARN of the Kinesis Data Analytics application from which to remove
-- the tags.
--
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "KinesisAnalytics_20180523.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
