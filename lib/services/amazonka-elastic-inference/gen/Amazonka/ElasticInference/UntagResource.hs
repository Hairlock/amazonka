...
-- |
-- Module      : Amazonka.ElasticInference.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The ARN of the Elastic Inference Accelerator to untag.
--
-- 'tagKeys', 'untagResource_tagKeys' - The list of tags to remove from the Elastic Inference Accelerator.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
