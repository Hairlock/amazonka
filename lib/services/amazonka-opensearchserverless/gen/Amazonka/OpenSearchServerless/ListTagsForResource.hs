...
-- |
-- Module      : Amazonka.OpenSearchServerless.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource. The resource must be
-- active (not in the @DELETING@ state), and must be owned by the account
-- ID included in the request.
newListTagsForResource ::
  -- | 'resourceArn'
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "OpenSearchServerless.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
