...
-- |
-- Module      : Amazonka.OpenSearchServerless.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the resource to remove tags from. The
-- resource must be active (not in the @DELETING@ state), and must be owned
-- by the account ID included in the request.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag or set of tags to remove from the resource. All tag keys in the
-- request must be unique.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "OpenSearchServerless.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
