...
-- |
-- Module      : Amazonka.FSx.TagResource
...
--
-- 'resourceARN', 'tagResource_resourceARN' - The Amazon Resource Name (ARN) of the Amazon FSx resource that you want
-- to tag.
--
-- 'tags', 'tagResource_tags' - A list of tags for the resource. If a tag with a given key already
-- exists, the value is replaced by the one specified in this parameter.
newTagResource ::
  -- | 'resourceARN'
  Prelude.Text ->
...
instance Data.ToHeaders TagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AWSSimbaAPIService_v20180301.TagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
