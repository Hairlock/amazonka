...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the resource that a tag list is
-- requested for.
--
-- It must be the ARN of an App Runner resource.
newListTagsForResource ::
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AppRunner.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A list of the tag key-value pairs that are associated with the resource.
--
