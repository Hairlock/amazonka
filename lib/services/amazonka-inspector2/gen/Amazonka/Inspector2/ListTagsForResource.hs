...
-- |
-- Module      : Amazonka.Inspector2.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon resource number (ARN) of the resource to list tags of.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
