...
-- |
-- Module      : Amazonka.Amplify.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) to use to untag a resource.
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag keys to use to untag a resource.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
