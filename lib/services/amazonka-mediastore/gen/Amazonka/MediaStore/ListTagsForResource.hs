...
--
-- 'resource', 'listTagsForResource_resource' - The Amazon Resource Name (ARN) for the container.
newListTagsForResource ::
  -- | 'resource'
  Prelude.Text ->
  ListTagsForResource
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "MediaStore_20170901.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - An array of key:value pairs that are assigned to the container.
--
