...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Number (ARN) of a resource from which you want to
-- remove tags. For example,
-- @arn:aws:opsworks-cm:us-west-2:123456789012:server\/test-owcm-server\/EXAMPLE-66b0-4196-8274-d1a2bEXAMPLE@.
--
-- 'tagKeys', 'untagResource_tagKeys' - The keys of tags that you want to remove.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  UntagResource
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "OpsWorksCM_V2016_11_01.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
