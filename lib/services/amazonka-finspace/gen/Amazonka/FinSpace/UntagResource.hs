...
-- |
-- Module      : Amazonka.FinSpace.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - A FinSpace resource from which you want to remove a tag or tags. The
-- value for this parameter is an Amazon Resource Name (ARN).
--
-- 'tagKeys', 'untagResource_tagKeys' - The tag keys (names) of one or more tags to be removed.
newUntagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  -- | 'tagKeys'
